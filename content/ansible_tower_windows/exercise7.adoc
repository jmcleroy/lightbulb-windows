...
If your server's Windows Update configuration is set to automatically download but not install, you can utilize the module to stage updates by telling it to `search` for updates.
...
Create a folder called *win_updates* and a file called `site.yml`
