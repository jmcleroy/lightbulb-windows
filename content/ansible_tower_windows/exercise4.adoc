...
image::4-project-sync.png[title="Project Sync"]
...
image::4-create-job-template.png[title="Create Job Template",width=1000]
...
image::4-survey.png[title="Survey Form",width=1000]
...
image::4-survey-prompt.png[title="Survey Prompt",width=1000]
...
image::4-job-summary-details.png[title="Job Summary"]
...
image::4-job-summary-output.png[title="Play and Task Output"]
...
image::4-website-output.png[title="New Website with Personalized Test Message",width=1000]
