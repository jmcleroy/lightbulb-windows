...
image::5-vscode-iis-yaml.png[title="site.yml part 1",width=1000]
...
image::5-vscode-template.png[title="index.html template",width=1000]
...
To test this playbook, we need to create a new Job Template to run this playbook.  So goto 'Template' and click 'Add' again.
...
Click on the rocketship icon image:at_launch_icon.png[Add,35,25] for the *IIS Advanced* Job Template.
